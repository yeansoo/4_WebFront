document.getElementById("btn1").addEventListener("click",function(){
    ...
    const product={
        ...
        'information':function(){// 객체의 기능
            ...
            // 해당 객체의 변수(key)가 아닌 
            // 전역변수가 선택된다.
            // 왜? 같은 객체의 변수(key)를 선택하는 방법이 별도로 존재
...
document.getElementById("btn2").addEventListener("click",function(){
    ...
    stdList.push(new Student(1,2,"김브코"));
    stdList.push(new Student(2,4,"김길동"));
    stdList.push(new Student(4,2,"왕방방"));
    stdList.push(new Student(5,1,"조예련"));
    stdList.push(new Student(1,3,"이리따"));
