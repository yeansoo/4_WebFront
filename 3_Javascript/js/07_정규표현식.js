...
document.getElementById("check1").addEventListener("click",function(){
    ...
    const str2="java, db, htm;, css, js, spring, mybatis 모두 사용중 입니다. ";
...
document.getElementById("check2").addEventListener("click",function(){
    ...
    div1.innerHTML+="/[abcd]/,qwerty : "+regEx1.test("querty")+"<hr>";
    ...
    const regEx3=/^[abcd]/;
    div1.innerHTML+="/^[abcd]/, group100 : "+regEx3.test("group100")+"<hr>";
    div1.innerHTML+="/^[abcd]/, apple : "+regEx3.test("apple")+"<hr>";
   
    // $(달러) : 문자열의 끝을 의미
    const regEx4=/team$/;

    div1.innerHTML+="/team$/, A-team : "+regEx4.test("A-team")+"<hr>";
    div1.innerHTML+="/team$/, A-team : "+regEx4.test("Atea -a")+"<hr>";
    ...
    const regEx5=/^[ABCD]-teams$$/;

    div1.innerHTML+="/[ABCD]-teams$$$/, A-team : "+regEx4.test("A-team")+"<hr>";
    div1.innerHTML+="/team$/, A-team : "+regEx4.test("Atea -a")+"<hr>";
